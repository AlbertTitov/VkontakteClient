...
import newfarmstudio.vkontakteclient.event.SendCommentEventOnSubscribe;
import newfarmstudio.vkontakteclient.event.SendCreatedPostEventOnSubscribe;
import newfarmstudio.vkontakteclient.event.UploadFileEventOnSubscribe;
import newfarmstudio.vkontakteclient.event.UploadPhotoEventOnSubscribe;
import newfarmstudio.vkontakteclient.model.view.CreatePostTextViewModel;
...
import newfarmstudio.vkontakteclient.ui.dialog.AddAttachmentDialogFragment;
...
public class CreatePostActivity extends BaseActivity {
    ...
    private void post() {
        ...
        if (mType != null && mType.equals("comment")) {
            ...
            o = new SendCreatedPostEventOnSubscribe(ApiConstants.MY_USER_ID,
